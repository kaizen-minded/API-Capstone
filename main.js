			...
			if (status == google.maps.places.PlacesServiceStatus.OK) {
				...
				<div class="card">
					...
					<div class="card-content">
						<h4 class="card-rating">Rating: <span class="query-rating">${place.rating}</span><i class="fas fa-star"></i></h4>
						<h4>Price: <span>${formResponse.setNumberOfDollar(place.price_level, i)}</h4>
						<p class="card-address">${place.formatted_address}</p>
					</div>
				</div>
				</div>
				</article>
